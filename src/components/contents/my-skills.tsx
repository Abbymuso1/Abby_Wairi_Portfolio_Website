            ...
            >
                <div className="w-full">
                    ...
                    <p className="text-justify lg:leading-7 text-foreground/80 lg:text-start mt-10">
                        A creative problem solver with programming experience, I&apos;ve explored diverse programming languages, libraries, and technology stacks, honing my skills in both Frontend, Backend, and App development.
                    </p>
